      ...
      <DropdownMenuTrigger className="focus:outline-none" asChild>
        <button
          className="w-full text-md font-semibold px-3 flex
                    items-center h-12 border-neutral-200 dark:border-[#CBFF01]
                    border-b-2 hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition dark:dark:bg-gradient-to-r from-blue-600 to-black"
        >
          {server.name}
